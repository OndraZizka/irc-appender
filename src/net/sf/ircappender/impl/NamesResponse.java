 ...
 * @author hendrik
 */
class NamesResponse implements IRCResponseHandler {

	// :calvino.freenode.net 353 ircappender = #arianne-test :ircappender hendrik
	private final Pattern pattern = Pattern.compile("(?i):[^ ]* 353 [^:]*:(.*)");
